...
import cn.KiesPro.utils.AStarCustomPathFinder;
import cn.KiesPro.utils.Helper;
import cn.KiesPro.utils.TimerUtil;
import cn.KiesPro.utils.Vec3;
...
extends Module {
    ...
    private List<EntityLivingBase> targets = new CopyOnWriteArrayList<EntityLivingBase>();
    ...
    public TPAura() {
        ...
        this.addValues(CPS,RANGE,MAXT,PLAYERS,ANIMALS,MOBS,INVISIBLES,TEAMS);
    }
