    ...
    public static class ChatMessageBuilder {
        ...
        public ChatMessageBuilder(boolean prependDefaultPrefix, boolean useDefaultMessageColor) {
            if (prependDefaultPrefix) {
                ...
                this.theMessage.appendSibling(new ChatMessageBuilder(false, false).appendText(String.valueOf(EnumChatFormatting.DARK_GRAY + "[" + EnumChatFormatting.RED + "KiesPro" + EnumChatFormatting.DARK_GRAY + "]" + " ")).setColor(EnumChatFormatting.RED).build().getChatComponent());
            }
