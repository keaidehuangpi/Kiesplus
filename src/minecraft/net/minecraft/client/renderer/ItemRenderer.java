...
import cn.KiesPro.module.modules.render.Animation;
...
public class ItemRenderer {
    ...
    private void doItemUsedTransformations(float swingProgress) {
        ...
        float var3;
        float var4;
        if ((Boolean) Animation.Smooth.getValue()) {
            ...
            GlStateManager.translate((double) var2 + (Double) Animation.swingx.getValue(), (double) var3 + (Double) Animation.swingy.getValue(), (double) var4 + (Double) Animation.swingz.getValue());
        } else {
    ...
    public void renderItemInFirstPerson(float partialTicks) {
        ...
        Animation hud = (Animation) Client.instance.getModuleManager().getModuleByClass(Animation.class);
                ...
                if (abstractclientplayer.getItemInUseCount() > 0) {
                    ...
                    switch ($SWITCH_TABLE$net$minecraft$item$EnumAction()[enumaction.ordinal()]) {
                        case 1:
                            ...
                            GlStateManager.translate((Double) Animation.swingx.getValue(), (Double) Animation.swingy.getValue(), (Double) Animation.swingz.getValue());
                            break;
                        case 2:
                            GlStateManager.translate((Double) Animation.swingx.getValue(), (Double) Animation.swingy.getValue(), (Double) Animation.swingz.getValue());
                        case 3:
                        ...
                        case 4:
                            byte var5 = 0;
                            Animation Ani = (Animation) Client.instance.getModuleManager().getModuleByClass(Animation.class);
                            GlStateManager.translate((Double) Animation.x.getValue(), (Double) Animation.y.getValue(), (Double) Animation.z.getValue());
                            if (!Client.instance.getModuleManager().getModuleByClass(Animation.class).isEnabled()) {
                                ...
                                if (Animation.mode.getValue() == Animation.renderMode.Swang) {
                                    var5 = 0;
                                }
                                ...
                                if (Animation.mode.getValue() == Animation.renderMode.Swong) {
                                    var5 = 3;
                                }

                                if (Animation.mode.getValue() == Animation.renderMode.SwAing) {
                                    var5 = 4;
                                }

                                if (Animation.mode.getValue() == Animation.renderMode.Remix) {
                                    var5 = 5;
                                }

                                if (Animation.mode.getValue() == Animation.renderMode.Custom) {
                                    var5 = 6;
                                }

                                if (Animation.mode.getValue() == Animation.renderMode.Null) {
                                    var5 = 7;
                                }
                                ...
                                if (Animation.mode.getValue() == Animation.renderMode.Punch) {
                                    var5 = 10;
                                }

                                if (Animation.mode.getValue() == Animation.renderMode.Winter) {
                                    var5 = 11;
                                }

                                if (Animation.mode.getValue() == Animation.renderMode.Rotate) {
                                    var5 = 12;
                                }

                                if (Animation.mode.getValue() == Animation.renderMode.Circle) {
                                    //var5 = 13;
                                    circle2(mc.thePlayer.getSwingProgress(partialTicks));
                                    this.func_178103_d();
                                }
                                ...
                                if (Animation.mode.getValue() == Animation.renderMode.Russia) {
                                    var5 = 13;
                                }
                                ...
                                switch (var5) {
                                    ...
                                    case 13:
                                        ...
                                        GlStateManager.rotate((float) this.ticks * 0.2F * ((Double) Animation.Speed.getValue()).floatValue(), 0.0F, 0.0F, 1.0F);
                    ...
                    byte var5 = 0;
                    Animation Ani = (Animation) Client.instance.getModuleManager().getModuleByClass(Animation.class);
                    if ((Boolean) Animation.EveryThingBlock.getValue() && this.mc.gameSettings.keyBindUseItem.isKeyDown()) {
                        GL11.glTranslated((Double) Animation.x.getValue(), (Double) Animation.y.getValue(), (Double) Animation.z.getValue());
                        if (!Client.instance.getModuleManager().getModuleByClass(Animation.class).isEnabled()) {
                            this.transformFirstPersonItem(f2 / 2.0F, f1);
                            this.doBlockTransformations();
                        } else {
