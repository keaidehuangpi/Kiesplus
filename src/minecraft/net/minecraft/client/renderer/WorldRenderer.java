...
import cn.KiesPro.module.modules.render.Xray;
...
public class WorldRenderer
{
    ...
    public void putColorMultiplier(float red, float green, float blue, int p_178978_4_)
    {
        ...
        if (x.isEnabled()) {
        	j = getColor(k, l, i1, x.getOpacity());
        }
	   ...
	   public void func_178961_b(int p_178961_1_, int p_178961_2_, int p_178961_3_, int p_178961_4_) {
		      if (!this.needsUpdate) {
		         ...
		         if (!this.vertexFormat.hasColor()) {
		            VertexFormatElement var5 = new VertexFormatElement(0, VertexFormatElement.EnumType.UBYTE, VertexFormatElement.EnumUsage.COLOR, 4);
		            this.vertexFormat.func_181721_a(var5);
		         }

		         if (ByteOrder.nativeOrder() == ByteOrder.LITTLE_ENDIAN) {
		            this.rawIntBuffer.put(p_178961_4_ << 24 | p_178961_3_ << 16 | p_178961_2_ << 8 | p_178961_1_);
		         } else {
		            this.rawIntBuffer.put(p_178961_1_ << 24 | p_178961_2_ << 16 | p_178961_3_ << 8 | p_178961_4_);
		         }
		      }
