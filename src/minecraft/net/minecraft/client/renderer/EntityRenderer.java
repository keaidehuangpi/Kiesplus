...
import cn.KiesPro.module.modules.render.NoHurtCam;
...
public class EntityRenderer implements IResourceManagerReloadListener
{
    ...
    private void hurtCameraEffect(float partialTicks)
    {
        ...
        {
        	if(Client.instance.getModuleManager().getModuleByClass(NoHurtCam.class).isEnabled()) return;
            ...
            else
            {
                ...
                for (int i = 0; i < 8; ++i)
                {
                    ...
                    if (movingobjectposition != null)
                    {
                        ...
                        if (d7 < d3 && !ModuleManager.getModuleByName("ViewClip").isEnabled())
                        {
                            d3 = d7;
                        }
                    }
        ...
        if (this.lightmapUpdateNeeded)
        {
            ...
            if (worldclient != null)
            {
                ...
                for (int i = 0; i < 256; ++i)
                {
                    ...
                    float f16 = ModuleManager.getModuleByName("Xray").isEnabled() ? 10000.0f : this.mc.gameSettings.gammaSetting;
                    float f17 = 1.0F - f8;
                    float f13 = 1.0F - f9;
                    float f14 = 1.0F - f10;
