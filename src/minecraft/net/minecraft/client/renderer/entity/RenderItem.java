...
import cn.KiesPro.module.modules.render.EnchantEffect;
import cn.KiesPro.utils.render.ColorUtils;
    ...
    private void renderEffect(IBakedModel model)
    {
        if (ModuleManager.getModuleByClass(EnchantEffect.class).isEnabled()) {
            if (!(Config.isCustomItems() && !CustomItems.isUseGlint() || Config.isShaders() && Shaders.isShadowPass)) {
                ...
                if (EnchantEffect.Rainbow.getValue()) {
                    this.renderModel(model, ColorUtils.rainbow(1,1).getRGB());
                } else {
                    this.renderModel(model, new Color(EnchantEffect.r.getValue().intValue(), EnchantEffect.r.getValue().intValue(), EnchantEffect.r.getValue().intValue()).getRGB());
                }
                GlStateManager.popMatrix();
                GlStateManager.pushMatrix();
                GlStateManager.scale(8.0f, 8.0f, 8.0f);
                ...
                if (EnchantEffect.Rainbow.getValue()) {
                    ...
                    this.renderModel(model, new Color(EnchantEffect.r.getValue().intValue(), EnchantEffect.g.getValue().intValue(), EnchantEffect.b.getValue().intValue()).getRGB());
                }
                GlStateManager.popMatrix();
        ...
        } else if (!Config.isCustomItems() || CustomItems.isUseGlint())
        {
