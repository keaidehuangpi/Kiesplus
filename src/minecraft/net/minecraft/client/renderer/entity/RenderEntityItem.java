...
import cn.KiesPro.module.modules.render.ItemPhysic;
import cn.KiesPro.module.modules.render.NoRender;
...
public class RenderEntityItem extends Render<EntityItem>
{
    ...
    {
    	if(Client.instance.getModuleManager().getModuleByClass(ItemPhysic.class).isEnabled()) {
    		ItemPhysic.doRenderItemPhysic(entity, x, y, z, entityYaw, partialTicks);
    		return;
    	}
        if (Client.instance.getModuleManager().getModuleByClass(NoRender.class).isEnabled()) {
            return;
        }
