...
public abstract class GuiContainer extends GuiScreen
{
    ...
    public void initGui()
    {
        ...
        this.buttonList.add(new GuiButton(6969, 2, 2, 70, 20, "Disable Aura"));
        this.buttonList.add(new GuiButton(696969, 2, 20, 90, 20, "Disable Manager"));
    ...
    protected void mouseClicked(int mouseX, int mouseY, int mouseButton) throws IOException
    {
        ...
        for (Object aButtonList : this.buttonList) {
            ...
            if (var52.mousePressed(this.mc, mouseX, mouseY) && var52.id == 6969) {
            	Client.instance.getModuleManager().getModuleByClass(Killaura.class).setEnabled(false);
            }
            if (var52.mousePressed(this.mc, mouseX, mouseY) && var52.id == 696969) {
            	Client.instance.getModuleManager().getModuleByClass(ChestStealer.class).setEnabled(false);
            	Client.instance.getModuleManager().getModuleByClass(InvCleaner.class).setEnabled(false);
            }
        }
