...
import cn.KiesPro.module.modules.movement.NoSlow;
import cn.KiesPro.module.modules.player.Freecam;
import cn.KiesPro.module.modules.world.Phase;
...
public class EntityPlayerSP extends AbstractClientPlayer
{
    ...
    protected boolean pushOutOfBlocks(double x, double y, double z)
    {
		...
		EventBus.getInstance().call(pushEvent);
