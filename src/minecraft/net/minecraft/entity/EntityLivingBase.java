...
import cn.KiesPro.api.events.world.EventLivingUpdate;
...
public abstract class EntityLivingBase extends Entity
{
    ...
    public static float rotationPitchHead;

    /** Entity head rotation at previous tick */
    ...
    public double KillAuraESPAnimation;
    public boolean isUp;
    ...
    public void onEntityUpdate()
    {
        ...
        EventBus.getInstance().call(new EventLivingUpdate(this));
    ...
    {
        return 6 + (int)(6 - 6 * Animation.swingspeed.getValue()) * 2;
