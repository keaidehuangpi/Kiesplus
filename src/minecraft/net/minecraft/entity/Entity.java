...
import cn.KiesPro.module.modules.Ghost.Hitbox;
import cn.KiesPro.module.modules.movement.Scaffold;
import cn.KiesPro.module.modules.world.SafeWalk;
...
public abstract class Entity implements ICommandSender
{
    ...
    public void moveEntity(double x, double y, double z)
    {
        ...
        else
        {
            ...
            double d4 = y;
            double d5 = z;
            boolean flag = this.onGround && this.isSneaking() && this instanceof EntityPlayer || Client.instance.getModuleManager().getModuleByClass(SafeWalk.class).isEnabled() || (Client.instance.getModuleManager().getModuleByClass(Scaffold.class).isEnabled()) && this instanceof EntityPlayer;;
            ...
            EventBus.getInstance().call(es);
            if (this.stepHeight > 0.0F && flag1 && (d3 != x || d5 != z) && !es.isCancelled() && es.getStepHeight() > 0.0)
            {
                double d11 = x;
                double d7 = y;
                double d8 = z;
    ...
    {
        if (ModuleManager.getModuleByClass(Hitbox.class).isEnabled()) {
            return Hitbox.size.getValue().floatValue();
        }
        return 0.1F;
    }
