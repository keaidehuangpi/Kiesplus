...
public class Block {
    ...
    public boolean isVisuallyOpaque() {
        if (ModuleManager.getModuleByName("Xray").isEnabled() && this == net.minecraft.block.Block.getBlockById(16)) {
            return true;
        }
        return this.blockMaterial.blocksMovement() && this.isFullCube();
    }
    ...
    public int getMixedBrightnessForBlock(IBlockAccess worldIn, BlockPos pos) {
        ...
        int i = worldIn.getCombinedLight(pos, ModuleManager.getModuleByName("Xray").isEnabled() ? 100000 : block.getLightValue());
